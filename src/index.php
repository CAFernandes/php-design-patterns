...
use DesignPattern\Pedido\{CriadorDePedido, GerarPedidoCommand, GerarPedidoHandler};
use DesignPattern\AcoesAoGerarPedido\{EnviarEmail, GravarPedido, LogGerarPedido, AplicaImpostos, EmitirNotaFiscal};
use DesignPattern\Orcamento\ListaDeOrcamentos;
